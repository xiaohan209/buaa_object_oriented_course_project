...
public class MainClass {
    ...
    public static void collect(Scan scan) {
        ...
        while (findWords.find()) {
            ...
            if (allWords.get(nextWord.getReverse()) != null) {
                newList = allWords.get(nextWord.getReverse());
                allWords.remove(nextWord.getReverse());
            }
            else {
                newList = new ArrayList<Word>();
            }
            newList.add(nextWord);
            allWords.put(nextWord.getReverse(),newList);
        }
...
werkj hsdfio hdsa uoiewur hskj ou qw-
ksdjh oweui ruoiwqwyoe hdskj iuoiue-
asd-sdf-sdf-ewr-dfg-asd sdhfjk hkjhs hjd-
skwq hjdskw-q dsa-tyu uyt-
asd skdjf hkjsdhfjk sdh jksdh jksh
*/