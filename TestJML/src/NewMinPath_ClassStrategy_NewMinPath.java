 ...
 * class-scope test values for type NewMinPath.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class NewMinPath_ClassStrategy_NewMinPath 
  extends PackageStrategy_NewMinPath {
  /**
   * @return class-scope values for type NewMinPath.
   */
  public RepeatedAccessIterator<?> classValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add class-scope NewMinPath values or generators here */ });
  }

  /**
   * The use of reflection can be controlled here for  
   * parameters of type NewMinPath
   ...
   */
  public NewMinPath_ClassStrategy_NewMinPath() {
    super();
    setReflective(false);
