/*
 * Test Oracle Class for EqualPersonIdException
...
public /*@ nullable_by_default */ class EqualPersonIdException_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {EqualPersonIdException_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(EqualPersonIdException_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(EqualPersonIdException.class),
  ...
  public void test_EqualPersonIdException__0
  () {
    try {
      new EqualPersonIdException();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_EqualPersonIdException__0".equals($e.getStackTrace()[3].getMethodName())) {
   ...
   *
   * @param the_test_object The EqualPersonIdException to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_print__0
  (final EqualPersonIdException the_test_object ) {
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    ...
    (new ParameterArrayIterator(EqualPersonIdException_InstanceStrategy.class));
  }
}