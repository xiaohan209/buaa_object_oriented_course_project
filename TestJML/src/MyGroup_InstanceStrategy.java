 ...
 * instances of MyGroup for testing, using
 * parameters from constructor tests.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class MyGroup_InstanceStrategy extends ObjectStrategy {
  /**
   * @return local-scope instances of MyGroup.
   */
  public RepeatedAccessIterator<?> localValues() {
    return new ObjectArrayIterator<Object>
    (new Object[]
     { /* add MyGroup values or generators here */ });
  }

  /**
   * @return default instances of MyGroup, generated
   *  using constructor test parameters.
   */ 
  public RepeatedAccessIterator<MyGroup> defaultValues() {
    final List<RepeatedAccessIterator<MyGroup>> iters = 
      new LinkedList<RepeatedAccessIterator<MyGroup>>();

    // an instantiation iterator for the default constructor
    // (if there isn't one, it will fail silently)
    iters.add(new InstantiationIterator<MyGroup>
      (MyGroup.class, 
       new Class<?>[0], 
       new ObjectArrayIterator<Object[]>(new Object[][]{{}})));

    // parameters for method MyGroup(int)
    iters.add(new InstantiationIterator<MyGroup>
      (MyGroup.class, 
       new Class<?>[]
       {int.class},
       MyGroup_JML_Test.p_MyGroup__int_id__0().wrapped()));

    return new NonNullMultiIterator<MyGroup>(iters);
  }
   ...
   */
  public MyGroup_InstanceStrategy() {
    super(MyGroup.class);
    setReflective(false);
