 ...
 * package-scope test values for type java.util.HashMap.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class PackageStrategy_java_util_HashMap 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type java.util.HashMap.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope java.util.HashMap values or generators here */ });
  }
   ...
   */
  public PackageStrategy_java_util_HashMap() {
    super(java.util.HashMap.class);
    setReflective(false);
