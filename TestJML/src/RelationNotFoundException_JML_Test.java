/*
 * Test Oracle Class for RelationNotFoundException
...
public /*@ nullable_by_default */ class RelationNotFoundException_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {RelationNotFoundException_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(RelationNotFoundException_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(RelationNotFoundException.class),
   ...
   *
   * @param the_test_object The RelationNotFoundException to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_print__0
  (final RelationNotFoundException the_test_object ) {
   ...
   */
  @Test(dependsOnMethods = { "test_racEnabled" })
  public void test_RelationNotFoundException__0
  () {
    try {
      ...
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_RelationNotFoundException__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    ...
    (new ParameterArrayIterator(RelationNotFoundException_InstanceStrategy.class));
  }
}