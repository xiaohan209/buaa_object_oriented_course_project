/*
 * Test Oracle Class for EqualGroupIdException
...
public /*@ nullable_by_default */ class EqualGroupIdException_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {EqualGroupIdException_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(EqualGroupIdException_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(EqualGroupIdException.class),
  ...
  public void test_EqualGroupIdException__0
  () {
    try {
      new EqualGroupIdException();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_EqualGroupIdException__0".equals($e.getStackTrace()[3].getMethodName())) {
   ...
   *
   * @param the_test_object The EqualGroupIdException to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_print__0
  (final EqualGroupIdException the_test_object ) {
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    ...
    (new ParameterArrayIterator(EqualGroupIdException_InstanceStrategy.class));
  }
}