 ...
 */
public /*@ nullable_by_default */ class MyNetwork_addGroup__Group_group__0__group
  extends MyNetwork_ClassStrategy_Group {
  /**
   ...
   */
  public MyNetwork_addGroup__Group_group__0__group() {
    super();
