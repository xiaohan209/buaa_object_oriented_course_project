 ...
 * test values for parameter "Class personClass" 
 * of method "Runner(Class, Class, Class)". 
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class Runner_Runner__Class_personClass__Class_networkClass__Class_groupClass__30__personClass
   ...
   * "Class personClass" of method "Runner(Class, Class, Class)" 
   ...
   */
  public Runner_Runner__Class_personClass__Class_networkClass__Class_groupClass__30__personClass() {
    super();
