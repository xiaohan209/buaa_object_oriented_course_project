 ...
 * package-scope test values for type java.math.BigInteger.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class PackageStrategy_java_math_BigInteger 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type java.math.BigInteger.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope java.math.BigInteger values or generators here */ });
  }
   ...
   */
  public PackageStrategy_java_math_BigInteger() {
