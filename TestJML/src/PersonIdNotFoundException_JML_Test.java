/*
 * Test Oracle Class for PersonIdNotFoundException
...
public /*@ nullable_by_default */ class PersonIdNotFoundException_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {PersonIdNotFoundException_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(PersonIdNotFoundException_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(PersonIdNotFoundException.class),
  ...
  public void test_PersonIdNotFoundException__0
  () {
    try {
      new PersonIdNotFoundException();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_PersonIdNotFoundException__0".equals($e.getStackTrace()[3].getMethodName())) {
   ...
   *
   * @param the_test_object The PersonIdNotFoundException to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_print__0
  (final PersonIdNotFoundException the_test_object ) {
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    ...
    (new ParameterArrayIterator(PersonIdNotFoundException_InstanceStrategy.class));
  }
}