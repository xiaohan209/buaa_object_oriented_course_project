 ...
 * class-scope test values for type java.math.BigInteger.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class MyPerson_ClassStrategy_java_math_BigInteger 
  extends PackageStrategy_java_math_BigInteger {
  /**
   * @return class-scope values for type java.math.BigInteger.
   */
  public RepeatedAccessIterator<?> classValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add class-scope java.math.BigInteger values or generators here */ });
  }

  /**
   * The use of reflection can be controlled here for  
   * parameters of type java.math.BigInteger
   ...
   */
  public MyPerson_ClassStrategy_java_math_BigInteger() {
    super();
    setReflective(false);
