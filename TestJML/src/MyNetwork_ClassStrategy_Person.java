 ...
 * class-scope test values for type Person.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class MyNetwork_ClassStrategy_Person 
  extends PackageStrategy_Person {
  /**
   * @return class-scope values for type Person.
   */
  public RepeatedAccessIterator<?> classValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add class-scope Person values or generators here */ });
  }
   ...
   */
  public MyNetwork_ClassStrategy_Person() {
    super();
    setReflective(false);
