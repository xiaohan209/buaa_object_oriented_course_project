 ...
 * package-scope test values for type Group.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class PackageStrategy_Group 
  extends ObjectStrategy {
  /**
   * @return package-scope values for type Group.
   */
  public RepeatedAccessIterator<?> packageValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add package-scope Group values or generators here */ });
  }
