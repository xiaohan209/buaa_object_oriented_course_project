 ...
 * test values for parameter "HashMap newReach" 
 * of method "void setReach(HashMap)". 
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class MyPerson_setReach__HashMap_newReach__10__newReach
  extends MyPerson_ClassStrategy_java_util_HashMap {
  /**
  ...
  public RepeatedAccessIterator<?> localValues() {
    ...
    (new Object[]
     { /* add local-scope java.util.HashMap values or generators here */ });
  }

  /**
   * Constructor.
   * The use of reflection can be controlled here for  
   * "HashMap newReach" of method "void setReach(HashMap)" 
   ...
   */
  public MyPerson_setReach__HashMap_newReach__10__newReach() {
    super();
