 ...
 * test values for parameter "Person friend" 
 * of method "void addRelation(Person, int)". 
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class MyPerson_addRelation__Person_friend__int_friendValue__0__friend
   ...
   * "Person friend" of method "void addRelation(Person, int)" 
   ...
   */
  public MyPerson_addRelation__Person_friend__int_friendValue__0__friend() {
    super();
