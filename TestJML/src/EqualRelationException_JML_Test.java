/*
 * Test Oracle Class for EqualRelationException
...
public /*@ nullable_by_default */ class EqualRelationException_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {EqualRelationException_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(EqualRelationException_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(EqualRelationException.class),
  ...
  public void test_EqualRelationException__0
  () {
    try {
      new EqualRelationException();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_EqualRelationException__0".equals($e.getStackTrace()[3].getMethodName())) {
   ...
   *
   * @param the_test_object The EqualRelationException to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_print__0
  (final EqualRelationException the_test_object ) {
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    ...
    (new ParameterArrayIterator(EqualRelationException_InstanceStrategy.class));
  }
}