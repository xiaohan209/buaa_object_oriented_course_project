/*
 * Test Oracle Class for NewMinPath
...
public /*@ nullable_by_default */ class NewMinPath_JML_Test {
  /**
  ...
  public static void main(String[] the_args) {
    ...
    final Class<?>[] classes = {NewMinPath_JML_Test.class};
  ...
  public void test_racEnabled() {
    ...
    Assert.assertFalse
    (Utils.isRACCompiled(NewMinPath_JML_Test.class),
     "JMLUnitNG tests must not be RAC-compiled when using OpenJML RAC.");
    Assert.assertTrue
    (Utils.isRACCompiled(NewMinPath.class),
   ...
   *
   * @param the_test_object The NewMinPath to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_hashCode__0
  (final NewMinPath the_test_object ) {
  ...
  /**
   * A test for method getMinPath.
   *
   * @param the_test_object The NewMinPath to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_getMinPath__0
  (final NewMinPath the_test_object ) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
        ("could not construct an object to test");
    ...
    try {
      the_test_object.getMinPath();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_getMinPath__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  /**
   * A test for method getPoint.
   *
   * @param the_test_object The NewMinPath to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_getPoint__0
  (final NewMinPath the_test_object ) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
        ("could not construct an object to test");
    ...
    try {
      the_test_object.getPoint();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_getPoint__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
   ...
   *
   * @param the_test_object The NewMinPath to call the test method on.
   * @param o The NewMinPath to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_compareTo__NewMinPath_o__0")
  public void test_compareTo__NewMinPath_o__0
  (final NewMinPath the_test_object, 
   final NewMinPath o) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
    ...
    try {
      ...
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_compareTo__NewMinPath_o__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
   ...
   *
   * @param minPath The int to be passed.
   * @param point The int to be passed.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_NewMinPath__int_minPath__int_point__0")
  public void test_NewMinPath__int_minPath__int_point__0
  (final int minPath, final int point) {
    try {
      new NewMinPath(minPath, point);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_NewMinPath__int_minPath__int_point__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  public static IteratorWrapper<Object[]> p_equals__Object_o__10() {
    ...
    (new ParameterArrayIterator
         (NewMinPath_InstanceStrategy.class,
          NewMinPath_equals__Object_o__10__o.class));
  }
  ...
  /**
   * Data provider for method int compareTo(NewMinPath).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_compareTo__NewMinPath_o__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_compareTo__NewMinPath_o__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (NewMinPath_InstanceStrategy.class,
          NewMinPath_compareTo__NewMinPath_o__0__o.class));
  }


  /**
   * Data provider for constructor NewMinPath(int, int).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_NewMinPath__int_minPath__int_point__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_NewMinPath__int_minPath__int_point__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (NewMinPath_NewMinPath__int_minPath__int_point__0__minPath.class,
          NewMinPath_NewMinPath__int_minPath__int_point__0__point.class));
  }
  ...
  public static IteratorWrapper<Object[]> p_instance_only() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator(NewMinPath_InstanceStrategy.class));
  }
}