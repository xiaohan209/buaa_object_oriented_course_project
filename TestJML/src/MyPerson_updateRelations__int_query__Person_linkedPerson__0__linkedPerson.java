 ...
 * test values for parameter "Person linkedPerson" 
 * of method "void updateRelations(int, Person)". 
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class MyPerson_updateRelations__int_query__Person_linkedPerson__0__linkedPerson
   ...
   * "Person linkedPerson" of method "void updateRelations(int, Person)" 
   ...
   */
  public MyPerson_updateRelations__int_query__Person_linkedPerson__0__linkedPerson() {
    super();
