 ...
 * class-scope test values for type java.util.HashMap.
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2020-05-23 16:24 +0800
 */
public /*@ nullable_by_default */ class MyPerson_ClassStrategy_java_util_HashMap 
  extends PackageStrategy_java_util_HashMap {
  /**
   * @return class-scope values for type java.util.HashMap.
   */
  public RepeatedAccessIterator<?> classValues() {
    return new ObjectArrayIterator<Object>
    (new Object[] 
     { /* add class-scope java.util.HashMap values or generators here */ });
  }

  /**
   * The use of reflection can be controlled here for  
   * parameters of type java.util.HashMap
   ...
   */
  public MyPerson_ClassStrategy_java_util_HashMap() {
    super();
    setReflective(false);
