 ...
 */
public /*@ nullable_by_default */ class NewMinPath_equals__Object_o__10__o
  extends NewMinPath_ClassStrategy_java_lang_Object {
  /**
   ...
   */
  public NewMinPath_equals__Object_o__10__o() {
    super();
