...
public class MyNetwork implements Network {
    ...
    public HashMap<Integer,Integer> money;
    public Stack stack;
    public HashMap<Integer,Integer> index;
    public HashMap<Integer,Integer> low;
    public HashMap<Integer,Integer> forbidden;
    public HashSet<Integer> visited;
    public int tarjanIndex;
